...
#define STRING_CONFIG_H_AUTHOR "(Pavel Roman, Brno)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anetka SKR V1.4"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 98.93
  #define DEFAULT_bedKi 19.77
  #define DEFAULT_bedKd 330.10
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 2, 5, 0 }
